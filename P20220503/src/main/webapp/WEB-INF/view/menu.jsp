...
<body>
  ...
  <div class="border-end bg-white" id="sidebar-wrapper">
     ...
     <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath }/mviewemberView/memberDelete.jsp">회원삭제검색</a>
